...
namespace Meriworks.Markdown.Tests
{
    ...
    public class SimpleTests : BaseTest
    {
        ...
        {
            var input = "#Header 1\nHeader 1\n========";
            var expected = "<h1 id=\"header-1\"><a href=\"#header-1\" class=\"h-anchor\"></a>Header 1</h1>\n\n<h1 id=\"header-1\"><a href=\"#header-1\" class=\"h-anchor\"></a>Header 1</h1>\n";
        ...
        {
            var input = "##Header 2\nHeader 2\n--------";
            var expected = "<h2 id=\"/header-2\"><a href=\"#/header-2\" class=\"h-anchor\"></a>Header 2</h2>\n\n<h2 id=\"/header-2\"><a href=\"#/header-2\" class=\"h-anchor\"></a>Header 2</h2>\n";
